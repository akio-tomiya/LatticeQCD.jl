module LieAlgebrafields
    ...
    import ..Gaugefields:SU3GaugeFields,SU3GaugeFields_1d,SU2GaugeFields,SU2GaugeFields_1d,GaugeFields,
        GaugeFields_1d,make_staple_double!,substitute!,projlink!,set_wing!, evaluate_wilson_loops!
    import ..Gaugefields
    ...
    function add_gaugeforce!(F::Array{N,1},U::Array{T,1},temps::Array{T_1d,1},temp_a::N,gparam::GaugeActionParam_autogenerator;fac = 1) where {T<: GaugeFields,N <: LieAlgebraFields,T_1d <: GaugeFields_1d} 
        temp1 = temps[1]
        temp2 = temps[2]
        temp3 = temps[3]
        staple = temps[4]
        ...
        for μ=1:4
            ...
            for i=1:gparam.numactions
                evaluate_wilson_loops!(staple,gparam.staples[i][μ],U,[temp1,temp2,temp3])
                ...
                projlink!(temp3,temp2)
                Gauge2Lie!(c,temp3)
                add!(F[μ],fac*gparam.βs[i]/gparam.β,c)
            end
        end
        return
    end
