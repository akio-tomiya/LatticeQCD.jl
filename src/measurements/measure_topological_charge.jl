...
function measure(m::M,itrj,U::Array{<: AbstractGaugefields{NC,Dim},1};additional_string = "") where {M <: Topological_charge_measurement,NC,Dim}
    ...
    for i=1:nummethod
        ...
        elseif methodname == "clover"
            ...
            Qimproved= calculate_topological_charge_improved(U,m.temp_UμνTA,Qclover,temps)
