                    ...
                    for i2 = 1:n2
                        @simd for i1 = 1:n1
                            ...
                            c.f[i1, i2, i3, i4, i5, i6] +=
                                alpha * a.f[i1, i2, i3, i4, i5, i6] +
                                beta * b.f[i1, i2, i3, i4, i5, i6]
                        end
                    end
                end
            end
...
function Wx!(
    xout::FermionFields,
    U::Array{GaugeFields,1},
    x::FermionFields,
    temps::Array{FermionFields,1},
    fparam::T,
) where {T<:FermiActionParam}
    error(
        "This FermionFields type is not supported yet in function Wx!. The type is $(typeof(x))",
    )
end
...
function Dx!(
    ...
    error(
        "This FermionFields type is not supported yet in function Dx!. The type is $(typeof(x))",
    )
...
function Ddagx!(
    ...
    error(
        "This FermionFields type is not supported yet in function Ddagx!. The type is $(typeof(x))",
    )
...
function fermion_shiftB!(
    ...
    μ,
    a::T,
) where {NC,T<:FermionFields}
    error(
        "This FermionFields type is not supported yet in function fermion_shiftB!. The type is $(typeof(x))",
    )
end
...
function Wdagx!(
    ...
    error(
        "This FermionFields type is not supported yet in function Wdagx!. The type is $(typeof(x))",
    )
end
