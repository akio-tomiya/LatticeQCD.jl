                ...
                for iz = 1:a.NZ
                    for iy = 1:a.NY
                        for ix = 1:a.NX
                            @simd for ic = 1:a.NC
                                c +=
                                    conj(a.f[ei5][ic, ix, iy, iz, it, α]) *
                                    b.f[ei5][ic, ix, iy, iz, it, α]
                            end
                        end
                    end
                end
                    ...
                    for i3 = 1:n3
                        for i2 = 1:n2
                            @simd for i1 = 1:n1
                                ...
                                c.f[ei5].f[i1, i2, i3, i4, i5, i6] +=
                                    alpha * a.f[ei5].f[i1, i2, i3, i4, i5, i6] +
                                    beta * b.f[ei5].f[i1, i2, i3, i4, i5, i6]
                            end
                        end
                    end
                end
                    ...
                    for i3 = 1:n3
                        for i2 = 1:n2
                            @simd for i1 = 1:n1
                                #println(a.f[i1,i2,i3,i4,i5,i6],"\t",b.f[i1,i2,i3,i4,i5,i6] )
                                c.f[ei5].f[i1, i2, i3, i4, i5, i6] =
                                    coeff * c.f[ei5].f[i1, i2, i3, i4, i5, i6] +
                                    alpha * a.f[ei5].f[i1, i2, i3, i4, i5, i6]
                            end
                        end
                    end
...
function D5DWx!(
    xout::DomainwallFermion,
    U::Array{G,1},
    x::DomainwallFermion,
    m,
    temps::Array{TW,1},
) where {T<:DomainwallFermion,G<:GaugeFields,TW<:WilsonFermion}
        ...
        for ialpha = 1:4
            for it = 1:NT
                for iz = 1:NZ
                    for iy = 1:NY
                        for k = 1:NC
                            a.f[ei5][k, 0, iy, iz, it, ialpha] =
                                a.BoundaryCondition[1] * a.f[ei5][k, NX, iy, iz, it, ialpha]
                        end
                    end
                end
            end
        ...
        for ialpha = 1:4
            for it = 1:NT
                for iz = 1:NZ
                    for iy = 1:NY
                        for k = 1:NC
                            a.f[ei5][k, NX+1, iy, iz, it, ialpha] =
                                a.BoundaryCondition[1] * a.f[ei5][k, 1, iy, iz, it, ialpha]
                        end
                    end
                end
            end
        ...
        for ialpha = 1:4
            for it = 1:NT
                for iz = 1:NZ
                    for ix = 1:NX
                        for k = 1:NC
                            a.f[ei5][k, ix, 0, iz, it, ialpha] =
                                a.BoundaryCondition[2] * a.f[ei5][k, ix, NY, iz, it, ialpha]
                        end
                    end
                end
            end
        ...
        for ialpha = 1:4
            for it = 1:NT
                for iz = 1:NZ
                    for ix = 1:NX
                        for k = 1:NC
                            a.f[ei5][k, ix, NY+1, iz, it, ialpha] =
                                a.BoundaryCondition[2] * a.f[ei5][k, ix, 1, iz, it, ialpha]
                        end
                    end
                end
            end
        ...
        for ialpha = 1:4
            ...
            for it = 1:NT
                for iy = 1:NY
                    for ix = 1:NX
                        for k = 1:NC
                            a.f[ei5][k, ix, iy, 0, it, ialpha] =
                                a.BoundaryCondition[3] * a.f[ei5][k, ix, iy, NZ, it, ialpha]
                            a.f[ei5][k, ix, iy, NZ+1, it, ialpha] =
                                a.BoundaryCondition[3] * a.f[ei5][k, ix, iy, 1, it, ialpha]
            ...
            for iz = 1:NZ
                for iy = 1:NY
                    for ix = 1:NX
                        for k = 1:NC
                            a.f[ei5][k, ix, iy, iz, 0, ialpha] =
                                a.BoundaryCondition[4] * a.f[ei5][k, ix, iy, iz, NT, ialpha]
                            a.f[ei5][k, ix, iy, iz, NT+1, ialpha] =
                                a.BoundaryCondition[4] * a.f[ei5][k, ix, iy, iz, 1, ialpha]
                        end
                    end
                end
            end
