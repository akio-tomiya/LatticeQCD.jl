...
struct SmearingParam_nosmearing <: SmearingParam end

abstract type SmearingParam_single <: SmearingParam end

abstract type SmearingParam_multi <: SmearingParam end
...
Base.@kwdef struct FermiActionParam_Wilson <: FermiActionParam
    ...
    function FermiActionParam_Wilson(
        hop,
        r,
        eps,
        Dirac_operator,
        ...
        smearing =
            construct_smearing(smearingparameters, loops_list, L, coefficients, numlayers)
        #smearing = Nosmearing()
...
Base.@kwdef struct FermiActionParam_WilsonClover <: FermiActionParam
    ...
    function FermiActionParam_WilsonClover(
        hop,
        r,
        eps,
        Dirac_operator,
...
function construct_smearing(smearingparameters, loops_list, L, coefficients, numlayers)
    if smearingparameters == "nothing"
        ...
        if numlayers == 1
            ...
            smearing = SmearingParam_stout_multi(
                smearing_single.staples_for_stout,
...
function GaugeActionParam_autogenerator(βs, loops, NC, couplinglist)
    ...
    return GaugeActionParam_autogenerator(
        βs,
        β,
        numactions,
        NC,
...
Base.@kwdef struct FermiActionParam_Domainwall <: FermiActionParam
    ...
    function FermiActionParam_Domainwall(
        N5,
        r,
        M,
        m,
...
function FermiActionParam_WilsonClover(
    ...
    return FermiActionParam_WilsonClover(
        hop,
        r,
        eps,
        "WilsonClover",
