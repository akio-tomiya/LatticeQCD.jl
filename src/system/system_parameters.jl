module System_parameters
    ...
    printlist_fermions  = ["quench","Dirac_operator","Clover_coefficient","r","hop","Nf","mass","BoundaryCondition",
                                "smearing_for_fermion","stout_numlayers","stout_ρ","stout_loops","isSLHMC"]
    ...
    # SLHMC setting             
    printlist_fermions_SLHMC = ["SLHMC_parameters"]
    # Measurement set
    ...
    struct Params
        ...
        function Params(system,actions,md,cg,wilson,staggered,measurement)
            ...
            SLHMC_parameters = set_params(system,"SLHMC_parameters",Dict())
