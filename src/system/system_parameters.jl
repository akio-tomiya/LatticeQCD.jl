module System_parameters
    ...
    # Physical setting 
    const printlist_physical = ["L","β","NC","Nthermalization","Nsteps","initial","update_method","Nwing"]
    # Physical setting(fermions)
    const printlist_fermions  = ["quench","Dirac_operator","Clover_coefficient","r","hop","Nf","mass","BoundaryCondition"]
    # System Control
    const printlist_systemcontrol = ["log_dir","logfile","saveU_dir","saveU_format","saveU_every","verboselevel","randomseed","measurement_basedir","measurement_dir"]
    # HMC related
    const printlist_HMCrelated = ["Δτ","SextonWeingargten","MDsteps","eps","MaxCGstep"]
    # Action parameter for SLMC
    const printlist_parameters_SLMC = ["use_autogeneratedstaples","couplingcoeff","couplinglist","coupling_loops"]
    # Measurement set
    const printlist_measurement = ["measurement_methods"]
