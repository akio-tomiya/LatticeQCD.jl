module Wizard
    ...
    function run_wizard_simple()
        ...
        verboselevel = 1 #parse(Int64,Base.prompt("verbose level ?", default="2"))
        if 1 ≤ verboselevel ≤ 3
        ...
        system["randomseed"] = 111 #parse(Int64,Base.prompt("Input random seed.", default="111"))
