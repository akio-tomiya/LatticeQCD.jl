...
staggered["Nf"] = 0
staggered["mass"] = 0
wilson["Domainwall_M"] = -1.0
wilson["Domainwall_m"] = 1.0
wilson["Domainwall_L5"] = 4
system["BoundaryCondition"] = [1, 1, 1, -1]
system["smearing_for_fermion"] = "nothing"
	
# System Control
system["log_dir"] = "./logs"
system["logfile"] = "HMC_L04040404_beta5.7_Domainwall.txt"
system["saveU_dir"] = "./confs_HMC_L04040404_beta5.7_Domainwall"
...
measurement["measurement_dir"] = "HMC_L04040404_beta5.7_Domainwall"
